...
if __name__ == "__main__":
    ...
    # 10000 det tests
    # test_strategies(1000, random_strat, det_mcts_strat_big, False, True)
    test_strategies(100, random_manual_strat, det_mcts_strat_big, False, True)
    test_strategies(100, det_mcts_strat_big, random_strat, True, False)
    test_strategies(100, det_mcts_strat_big, random_manual_strat, True, False)
